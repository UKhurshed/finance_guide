...
class CurrencyInit extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => CurrencyCubit(currencyRepository), child: CurrencyScreen(),);
  }
}
          ...
          if (state is CurrencyError) {
            ...
            return ListView.builder(
              ...
              return Card(
                ...
                child: ListTile(
                  title: Text(entries.elementAt(index).value.toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                  leading: Text(entries.elementAt(index).key,style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              );
            });
          }else{
            return Center(child: Text('Center Currency'),);
          }
        }
      ),
    );
